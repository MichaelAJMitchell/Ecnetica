...
def main():
    """
    Main function that sets up command-line argument parsing and initiates processing.
    
    Command line options:
    --file/-f: Process a single file (PDF, MD, or CSV)
    --directory/-d: Process all supported files in a directory
    --output/-o: Specify output JSON file (defaults to graph-data.json)
    """
